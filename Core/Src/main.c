...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
enum ModeEnumTypeDef{
  MODE_RUN,
  MODE_CALIBRATION
} current_mode;
//ModeEnumTypeDef  = MODE_RUN;
...
int main(void)
{
  ...
  //   //prepare
  //   led_on();
  //   HAL_Delay(3000); //2s delay to indicate calibration mode
  //   led_off();

  //   while(!isCalibButtonPressed()) //the second press saves settings to FLASH
  //   {
  //     led_blink(300);
  //   }
